...
$timevar = "SELECT time FROM draft ORDER BY time DESC LIMIT 0,1";
...
if (mysqli_num_rows($timevar_exec) > 0) {
    ...
    if ($emails) {
        ...
        foreach ($emails as $email_number) {
            ...
            $msg_ref = "draft_email_{$draft_email_number}.txt";
            $check_old_email_exist = "SELECT id FROM draft WHERE message='$msg_ref'";
...
header("Location:index.php?type=drafts");
?>   
